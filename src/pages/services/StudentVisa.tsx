...
import { GraduationCap, CheckCircle, FileText, Users, Clock, ArrowRight } from 'lucide-react';
        ...
        <div className="container-custom text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['USA', 'UK', 'Canada', 'Australia', 'Germany', 'Ireland', 'New Zealand'].map((country) => (
              <span key={country} className="px-6 py-3 bg-white rounded-full text-navy font-medium shadow-sm">
                {country}
              </span>
            ))}
          </div>
